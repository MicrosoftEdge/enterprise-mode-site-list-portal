...
namespace EMIEWebPortal.Common
{
    public class UNCAccessWithCredentials : IDisposable
    {
        ...
        /// <summary>
        /// Check if the path has the access or not
        /// </summary>
        ...
        {
            /*Splitting path only till Share path, trimming subsequent folder path for mapping, 
            probably this should resolve an error 1219 occuring intermittantly,
